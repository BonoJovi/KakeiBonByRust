...
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT)
VALUES
(2323, 'user_mgmt.period_settings_title', 'en', 'Aggregation Period Settings', 'user_mgmt', 'Period settings section title', datetime('now')),
(2324, 'user_mgmt.period_settings_title', 'ja', '集計起算日設定', 'user_mgmt', '集計起算日設定セクションタイトル', datetime('now')),
(2325, 'user_mgmt.period_settings_description', 'en', 'Customize the start day of monthly/yearly aggregation cycles to match your salary day, pension payment date, or any other personal schedule.', 'user_mgmt', 'Period settings description', datetime('now')),
(2326, 'user_mgmt.period_settings_description', 'ja', '給料日・年金振込日など、生活サイクルに合わせて月次・年次集計の起算日をカスタマイズできます。', 'user_mgmt', '集計起算日設定の説明', datetime('now')),
(2327, 'user_mgmt.period_settings_open', 'en', 'Open Period Settings', 'user_mgmt', 'Open period settings button', datetime('now')),
(2328, 'user_mgmt.period_settings_open', 'ja', '集計設定を開く', 'user_mgmt', '集計設定を開くボタン', datetime('now')),
(2329, 'user_mgmt.month_start_day_label', 'en', 'Monthly start day (1-31):', 'user_mgmt', 'Monthly start day label', datetime('now')),
(2330, 'user_mgmt.month_start_day_label', 'ja', '月次起算日 (1〜31):', 'user_mgmt', '月次起算日ラベル', datetime('now')),
(2331, 'user_mgmt.year_start_month_label', 'en', 'Yearly start month (1-12):', 'user_mgmt', 'Yearly start month label', datetime('now')),
(2332, 'user_mgmt.year_start_month_label', 'ja', '年次起算月 (1〜12):', 'user_mgmt', '年次起算月ラベル', datetime('now')),
(2333, 'user_mgmt.year_start_day_label', 'en', 'Yearly start day (1-31):', 'user_mgmt', 'Yearly start day label', datetime('now')),
(2334, 'user_mgmt.year_start_day_label', 'ja', '年次起算日 (1〜31):', 'user_mgmt', '年次起算日ラベル', datetime('now')),
(2335, 'user_mgmt.end_of_month_note', 'en', 'If the selected day does not exist in a month, the last day of that month is used.', 'user_mgmt', 'End-of-month fallback note', datetime('now')),
(2336, 'user_mgmt.end_of_month_note', 'ja', '選択した日が存在しない月は末日で対応します。', 'user_mgmt', '月末日対応の注意書き', datetime('now')),
(2337, 'user_mgmt.period_settings_load_failed', 'en', 'Failed to load period settings', 'user_mgmt', 'Period settings load failure', datetime('now')),
(2338, 'user_mgmt.period_settings_load_failed', 'ja', '集計設定の読み込みに失敗しました', 'user_mgmt', '集計設定読み込み失敗', datetime('now')),
...
-- RESOURCE_ID 2393/2394 reserved for category_mgmt.not_found (added in PR #83).
