...
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2103, 'maintenance.recalc_success', 'en', 'Recalculation complete: {0} updated, {1} unchanged, {2} total.', 'maintenance', 'Recalc success message', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2104, 'maintenance.recalc_success', 'ja', '再計算が完了しました：{0}件を更新、{1}件は変更なし、合計{2}件。', 'maintenance', '再計算成功メッセージ', datetime('now'));
