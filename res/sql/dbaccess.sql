...
CREATE TABLE IF NOT EXISTS USERS (
    ...
    MONTH_PERIOD_START_DAY INTEGER DEFAULT 1,
...
-- v2.3.0 aggregation period customization (user_mgmt + validation)
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT)
VALUES
(1291, 'user_mgmt.period_settings_title', 'en', 'Aggregation Period Settings', 'user_mgmt', 'Period settings section title', datetime('now')),
(1292, 'user_mgmt.period_settings_title', 'ja', '集計起算日設定', 'user_mgmt', '集計起算日設定セクションタイトル', datetime('now')),
(1293, 'user_mgmt.period_settings_description', 'en', 'Customize the start day of monthly/yearly aggregation cycles to match your salary day, pension payment date, or any other personal schedule.', 'user_mgmt', 'Period settings description', datetime('now')),
(1294, 'user_mgmt.period_settings_description', 'ja', '給料日・年金振込日など、生活サイクルに合わせて月次・年次集計の起算日をカスタマイズできます。', 'user_mgmt', '集計起算日設定の説明', datetime('now')),
(1295, 'user_mgmt.period_settings_open', 'en', 'Open Period Settings', 'user_mgmt', 'Open period settings button', datetime('now')),
(1296, 'user_mgmt.period_settings_open', 'ja', '集計設定を開く', 'user_mgmt', '集計設定を開くボタン', datetime('now')),
(1297, 'user_mgmt.month_start_day_label', 'en', 'Monthly start day (1-31):', 'user_mgmt', 'Monthly start day label', datetime('now')),
(1298, 'user_mgmt.month_start_day_label', 'ja', '月次起算日 (1〜31):', 'user_mgmt', '月次起算日ラベル', datetime('now')),
(1299, 'user_mgmt.year_start_month_label', 'en', 'Yearly start month (1-12):', 'user_mgmt', 'Yearly start month label', datetime('now')),
(1300, 'user_mgmt.year_start_month_label', 'ja', '年次起算月 (1〜12):', 'user_mgmt', '年次起算月ラベル', datetime('now')),
(1301, 'user_mgmt.year_start_day_label', 'en', 'Yearly start day (1-31):', 'user_mgmt', 'Yearly start day label', datetime('now')),
(1302, 'user_mgmt.year_start_day_label', 'ja', '年次起算日 (1〜31):', 'user_mgmt', '年次起算日ラベル', datetime('now')),
(1303, 'user_mgmt.end_of_month_note', 'en', 'If the selected day does not exist in a month, the last day of that month is used.', 'user_mgmt', 'End-of-month fallback note', datetime('now')),
(1304, 'user_mgmt.end_of_month_note', 'ja', '選択した日が存在しない月は末日で対応します。', 'user_mgmt', '月末日対応の注意書き', datetime('now')),
(1305, 'user_mgmt.period_settings_load_failed', 'en', 'Failed to load period settings', 'user_mgmt', 'Period settings load failure', datetime('now')),
(1306, 'user_mgmt.period_settings_load_failed', 'ja', '集計設定の読み込みに失敗しました', 'user_mgmt', '集計設定読み込み失敗', datetime('now')),
(1307, 'user_mgmt.period_settings_saved', 'en', 'Period settings saved', 'user_mgmt', 'Period settings save success', datetime('now')),
(1308, 'user_mgmt.period_settings_saved', 'ja', '集計設定を保存しました', 'user_mgmt', '集計設定保存成功', datetime('now')),
(1309, 'user_mgmt.period_settings_save_failed', 'en', 'Failed to save period settings', 'user_mgmt', 'Period settings save failure', datetime('now')),
(1310, 'user_mgmt.period_settings_save_failed', 'ja', '集計設定の保存に失敗しました', 'user_mgmt', '集計設定保存失敗', datetime('now')),
(1311, 'validation.invalid_period_start_day', 'en', 'Start day must be between 1 and 31', 'validation', 'Invalid period start day', datetime('now')),
(1312, 'validation.invalid_period_start_day', 'ja', '起算日は 1〜31 の範囲で指定してください', 'validation', '起算日範囲エラー', datetime('now')),
(1313, 'validation.invalid_period_start_month', 'en', 'Start month must be between 1 and 12', 'validation', 'Invalid period start month', datetime('now')),
(1314, 'validation.invalid_period_start_month', 'ja', '起算月は 1〜12 の範囲で指定してください', 'validation', '起算月範囲エラー', datetime('now'));
...
-- Admin access denied messages for transaction management (added 2025-01)
...
-- Scheduled transaction i18n resources (予定入出金)
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2053, 'transaction_mgmt.is_scheduled', 'en', 'Scheduled Transaction', 'transaction_mgmt', 'Scheduled transaction checkbox label', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2054, 'transaction_mgmt.is_scheduled', 'ja', '予定取引', 'transaction_mgmt', '予定取引チェックボックスラベル', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2055, 'transaction_mgmt.is_scheduled_desc', 'en', 'Mark as planned/scheduled', 'transaction_mgmt', 'Scheduled transaction description', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2056, 'transaction_mgmt.is_scheduled_desc', 'ja', '予定入出金として登録', 'transaction_mgmt', '予定取引の説明', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2057, 'transaction_mgmt.include_scheduled', 'en', 'Include Scheduled', 'transaction_mgmt', 'Include scheduled filter label', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2058, 'transaction_mgmt.include_scheduled', 'ja', '予定を含む', 'transaction_mgmt', '予定を含むフィルターラベル', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2059, 'transaction_mgmt.include_scheduled_desc', 'en', 'Show scheduled transactions', 'transaction_mgmt', 'Include scheduled filter description', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2060, 'transaction_mgmt.include_scheduled_desc', 'ja', '予定入出金を表示', 'transaction_mgmt', '予定を含むフィルターの説明', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2061, 'transaction_mgmt.scheduled_label', 'en', 'Scheduled', 'transaction_mgmt', 'Scheduled badge label', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2062, 'transaction_mgmt.scheduled_label', 'ja', '予定', 'transaction_mgmt', '予定バッジラベル', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2063, 'transaction_mgmt.confirm_scheduled', 'en', 'Mark this scheduled transaction as actual?', 'transaction_mgmt', 'Confirm scheduled transaction dialog', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2064, 'transaction_mgmt.confirm_scheduled', 'ja', 'この予定入出金を確定しますか？', 'transaction_mgmt', '予定確定ダイアログ', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2065, 'transaction_mgmt.confirm_btn', 'en', 'Confirm', 'transaction_mgmt', 'Confirm button label', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2066, 'transaction_mgmt.confirm_btn', 'ja', '確定', 'transaction_mgmt', '確定ボタンラベル', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2067, 'transaction_mgmt.confirm_error', 'en', 'Failed to confirm scheduled transaction', 'transaction_mgmt', 'Confirm error message', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2068, 'transaction_mgmt.confirm_error', 'ja', '予定入出金の確定に失敗しました', 'transaction_mgmt', '確定エラーメッセージ', datetime('now'));

-- Aggregation scheduled filter and error i18n resources
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2069, 'aggregation.error_invalid_year', 'en', 'Invalid year. Year must be between 1900 and 2100.', 'aggregation', 'Invalid year error message', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2070, 'aggregation.error_invalid_year', 'ja', '無効な年です。1900～2100の範囲で入力してください。', 'aggregation', '無効な年エラーメッセージ', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2071, 'aggregation.error_invalid_month', 'en', 'Invalid month. Month must be between 1 and 12.', 'aggregation', 'Invalid month error message', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2072, 'aggregation.error_invalid_month', 'ja', '無効な月です。1～12の範囲で入力してください。', 'aggregation', '無効な月エラーメッセージ', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2073, 'aggregation.error_invalid_date_range', 'en', 'Invalid date range. Start date must be before end date.', 'aggregation', 'Invalid date range error message', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2074, 'aggregation.error_invalid_date_range', 'ja', '無効な日付範囲です。開始日は終了日より前にしてください。', 'aggregation', '無効な日付範囲エラーメッセージ', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2075, 'aggregation.error_invalid_day', 'en', 'Invalid day for the specified month.', 'aggregation', 'Invalid day error message', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2076, 'aggregation.error_invalid_day', 'ja', '指定された月に対して無効な日です。', 'aggregation', '無効な日エラーメッセージ', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2077, 'aggregation.error_invalid_date_format', 'en', 'Invalid date format.', 'aggregation', 'Invalid date format error message', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2078, 'aggregation.error_invalid_date_format', 'ja', '無効な日付形式です。', 'aggregation', '無効な日付形式エラーメッセージ', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2079, 'common.not_authenticated', 'en', 'Not authenticated. Please login.', 'common', 'Not authenticated error message', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2080, 'common.not_authenticated', 'ja', '認証されていません。ログインしてください。', 'common', '未認証エラーメッセージ', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2081, 'aggregation.include_scheduled', 'en', 'Include Scheduled', 'aggregation', 'Include scheduled checkbox label', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2082, 'aggregation.include_scheduled', 'ja', '予定を含む', 'aggregation', '予定を含むチェックボックスラベル', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2083, 'aggregation.include_scheduled_desc', 'en', 'Include scheduled transactions', 'aggregation', 'Include scheduled checkbox description', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2084, 'aggregation.include_scheduled_desc', 'ja', '予定入出金を含む', 'aggregation', '予定を含むチェックボックス説明', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2085, 'aggregation.week_range_label', 'en', 'Target week', 'aggregation', 'Week range display label', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2086, 'aggregation.week_range_label', 'ja', '集計対象週', 'aggregation', '週範囲表示ラベル', datetime('now'));

-- Dashboard i18n resources (added 2025-01)
...
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2041, 'common.back', 'en', '← Back', 'common', 'Back button', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2042, 'common.back', 'ja', '← 戻る', 'common', '戻るボタン', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2043, 'common.hide', 'en', 'Hide', 'common', 'Hide button', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2044, 'common.hide', 'ja', '非表示', 'common', '非表示ボタン', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2045, 'category_mgmt.hide_confirm', 'en', 'Are you sure you want to hide this category? It will no longer appear in selection lists.', 'category_mgmt', 'Hide category confirmation', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2046, 'category_mgmt.hide_confirm', 'ja', 'この費目を非表示にしますか？選択リストに表示されなくなります。', 'category_mgmt', '費目非表示確認', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2047, 'category_mgmt.hide_confirm_with_children', 'en', 'Are you sure you want to hide this category? All sub-categories will also be hidden.', 'category_mgmt', 'Hide category with children confirmation', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2048, 'category_mgmt.hide_confirm_with_children', 'ja', 'この費目を非表示にしますか？配下の小分類もすべて非表示になります。', 'category_mgmt', '費目非表示確認（子カテゴリあり）', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2049, 'common.show', 'en', 'Show', 'common', 'Show/re-enable button', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2050, 'common.show', 'ja', '再表示', 'common', '再表示ボタン', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2051, 'category_mgmt.hidden', 'en', 'Hidden', 'category_mgmt', 'Hidden category label', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2052, 'category_mgmt.hidden', 'ja', '非表示', 'category_mgmt', '非表示カテゴリラベル', datetime('now'));

-- v2.0.0: Header recalculation prompts (auto-recompute TOTAL_AMOUNT from details)
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2087, 'detail_mgmt.header_recalc_confirm', 'en', 'The header total ({0}) differs from what the details would total ({1}).\n\nOverwrite the header with the recalculated value?', 'detail_mgmt', 'Confirm overwriting header total after detail or tax-setting change', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2088, 'detail_mgmt.header_recalc_confirm', 'ja', 'ヘッダの合計金額（{0}）が明細から計算した値（{1}）と一致しません。\n\nヘッダを再計算後の値で上書きしますか？', 'detail_mgmt', '明細編集や税方式変更後のヘッダ金額上書き確認', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2089, 'detail_mgmt.header_recalc_error', 'en', 'Failed to update the header total', 'detail_mgmt', 'Header recalculation persistence error', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2090, 'detail_mgmt.header_recalc_error', 'ja', 'ヘッダ合計の更新に失敗しました', 'detail_mgmt', 'ヘッダ再計算の保存エラー', datetime('now'));

-- v2.0.0: Data maintenance section on dashboard (bulk header total recalc + rollback)
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2091, 'maintenance.title', 'en', 'Data Maintenance', 'maintenance', 'Section heading on dashboard', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2092, 'maintenance.title', 'ja', 'データメンテナンス', 'maintenance', 'ダッシュボードのセクション見出し', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2093, 'maintenance.recalc_description', 'en', 'Recalculate every transaction''s header total from its details. A backup is taken automatically before the change.', 'maintenance', 'Description of the recalc action', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2094, 'maintenance.recalc_description', 'ja', '全取引のヘッダ合計金額を明細から再計算します。実行前に自動でバックアップを作成します。', 'maintenance', '再計算機能の説明', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2095, 'maintenance.recalc_button', 'en', 'Recalculate All Header Totals', 'maintenance', 'Recalc button label', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2096, 'maintenance.recalc_button', 'ja', 'ヘッダ合計を一括再計算', 'maintenance', '再計算ボタンラベル', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2097, 'maintenance.rollback_button', 'en', 'Roll Back to Pre-Recalc Backup', 'maintenance', 'Rollback button label', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2098, 'maintenance.rollback_button', 'ja', '再計算前の状態に戻す', 'maintenance', 'ロールバックボタンラベル', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2099, 'maintenance.recalc_confirm', 'en', 'Recalculate every transaction''s header total from its details? A backup of the database will be taken automatically before the change.', 'maintenance', 'Recalc confirm dialog', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2100, 'maintenance.recalc_confirm', 'ja', '全取引のヘッダ合計金額を明細から再計算しますか？\n\n実行前に自動でデータベースのバックアップを作成します。', 'maintenance', '再計算確認ダイアログ', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2101, 'maintenance.recalc_in_progress', 'en', 'Recalculating... Please wait.', 'maintenance', 'Recalc progress message', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2102, 'maintenance.recalc_in_progress', 'ja', '再計算中です。しばらくお待ちください。', 'maintenance', '再計算進行中メッセージ', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2103, 'maintenance.recalc_success', 'en', 'Recalculation complete: {0} tax-setting corrections, {1} total overwrites, {2} unchanged (out of {3} headers).', 'maintenance', 'Recalc success message', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2104, 'maintenance.recalc_success', 'ja', '再計算が完了しました：税方式補正 {0} 件、合計金額上書き {1} 件、変更なし {2} 件 / 合計 {3} 件。', 'maintenance', '再計算成功メッセージ', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2105, 'maintenance.recalc_error', 'en', 'Recalculation failed', 'maintenance', 'Recalc error message', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2106, 'maintenance.recalc_error', 'ja', '再計算に失敗しました', 'maintenance', '再計算エラーメッセージ', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2107, 'maintenance.rollback_confirm', 'en', 'Restore the header totals to their pre-recalculation values from the backup?', 'maintenance', 'Rollback confirm dialog', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2108, 'maintenance.rollback_confirm', 'ja', 'ヘッダの合計金額を再計算前の値（バックアップから）に戻しますか？', 'maintenance', 'ロールバック確認ダイアログ', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2109, 'maintenance.rollback_in_progress', 'en', 'Rolling back... Please wait.', 'maintenance', 'Rollback progress message', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2110, 'maintenance.rollback_in_progress', 'ja', '元に戻しています。しばらくお待ちください。', 'maintenance', 'ロールバック進行中メッセージ', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2111, 'maintenance.rollback_success', 'en', 'Rolled back {0} header totals to backup values.', 'maintenance', 'Rollback success message', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2112, 'maintenance.rollback_success', 'ja', '{0}件のヘッダ合計をバックアップ値に戻しました。', 'maintenance', 'ロールバック成功メッセージ', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2113, 'maintenance.rollback_error', 'en', 'Rollback failed', 'maintenance', 'Rollback error message', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2114, 'maintenance.rollback_error', 'ja', 'ロールバックに失敗しました', 'maintenance', 'ロールバックエラーメッセージ', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2115, 'maintenance.rollback_no_backup', 'en', 'No backup is available to roll back to.', 'maintenance', 'Rollback unavailable message', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2116, 'maintenance.rollback_no_backup', 'ja', 'ロールバック先のバックアップがありません。', 'maintenance', 'ロールバック不可メッセージ', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2117, 'maintenance.changelog_summary', 'en', 'View change log', 'maintenance', 'Disclosure summary for change log details', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2118, 'maintenance.changelog_summary', 'ja', '変更ログを表示', 'maintenance', '変更ログ詳細の開示見出し', datetime('now'));

-- v2.0.0: Account Balances panel on dashboard
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2119, 'dashboard.account_balances', 'en', 'Account Balances', 'dashboard', 'Account balances panel heading', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2120, 'dashboard.account_balances', 'ja', '口座別残高', 'dashboard', '口座残高パネルの見出し', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2121, 'dashboard.balances_as_of', 'en', 'As of:', 'dashboard', 'As-of date label', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2122, 'dashboard.balances_as_of', 'ja', '基準日：', 'dashboard', '基準日ラベル', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2123, 'dashboard.account_name', 'en', 'Account', 'dashboard', 'Account name column header', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2124, 'dashboard.account_name', 'ja', '口座', 'dashboard', '口座名カラム見出し', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2125, 'dashboard.balance', 'en', 'Balance', 'dashboard', 'Balance column header', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2126, 'dashboard.balance', 'ja', '残高', 'dashboard', '残高カラム見出し', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2127, 'dashboard.balances_loading', 'en', 'Loading...', 'dashboard', 'Loading state', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2128, 'dashboard.balances_loading', 'ja', '読み込み中...', 'dashboard', '読み込み中状態', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2129, 'dashboard.balances_empty', 'en', 'No accounts to display', 'dashboard', 'Empty balances state', datetime('now'));
...
-- Header-recalc custom modal (replaces native confirm with explicit choice; default = keep current).
-- The legacy `detail_mgmt.header_recalc_confirm` keys (2087/2088) are no longer referenced from code.
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2293, 'detail_mgmt.header_recalc_title', 'en', 'Header total mismatch', 'detail_mgmt', 'Title of the header-recalc reconciliation dialog', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2294, 'detail_mgmt.header_recalc_title', 'ja', '合計金額の不一致', 'detail_mgmt', 'ヘッダ再計算ダイアログのタイトル', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2295, 'detail_mgmt.header_recalc_body', 'en', 'The header total ({0}) differs from what the details would total ({1}). If you are still adding or editing details, keep the current header total.', 'detail_mgmt', 'Body of the header-recalc reconciliation dialog', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2296, 'detail_mgmt.header_recalc_body', 'ja', 'ヘッダの合計金額（{0}）が明細から計算した値（{1}）と一致しません。明細の追加・編集を続ける場合は、現在の合計を保持してください。', 'detail_mgmt', 'ヘッダ再計算ダイアログの本文', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2297, 'detail_mgmt.header_recalc_keep', 'en', 'Keep current total (recommended)', 'detail_mgmt', 'Primary button: keep current header total', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2298, 'detail_mgmt.header_recalc_keep', 'ja', '現在の合計を保持（推奨）', 'detail_mgmt', '主ボタン:現在のヘッダ合計を保持', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2299, 'detail_mgmt.header_recalc_apply', 'en', 'Overwrite with calculated total', 'detail_mgmt', 'Secondary button: overwrite header with computed total', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2300, 'detail_mgmt.header_recalc_apply', 'ja', '計算した値で上書き', 'detail_mgmt', '副ボタン:計算値でヘッダを上書き', datetime('now'));

-- Issue #50 follow-up: i18n keys for alert→toast migration on
-- account-management / transaction-management / category-management.
-- Code adoption (the actual showToast(i18n.t(...)) swap) is in a
-- separate PR; this batch is the data-side prerequisite.
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2301, 'account_mgmt.failed_to_initialize', 'en', 'Failed to initialize', 'account_mgmt', 'Initialization error message', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2302, 'account_mgmt.failed_to_initialize', 'ja', '初期化に失敗しました', 'account_mgmt', '初期化エラーメッセージ', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2303, 'account_mgmt.failed_to_load_templates', 'en', 'Failed to load templates', 'account_mgmt', 'Template load error', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2304, 'account_mgmt.failed_to_load_templates', 'ja', 'テンプレートの読み込みに失敗しました', 'account_mgmt', 'テンプレート読み込みエラー', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2305, 'account_mgmt.failed_to_save', 'en', 'Failed to save account', 'account_mgmt', 'Save error message', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2306, 'account_mgmt.failed_to_save', 'ja', '口座の保存に失敗しました', 'account_mgmt', '保存エラーメッセージ', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2307, 'account_mgmt.failed_to_delete', 'en', 'Failed to delete account', 'account_mgmt', 'Delete error message', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2308, 'account_mgmt.failed_to_delete', 'ja', '口座の削除に失敗しました', 'account_mgmt', '削除エラーメッセージ', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2309, 'account_mgmt.update_success', 'en', 'Account updated successfully', 'account_mgmt', 'Update success message', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2310, 'account_mgmt.update_success', 'ja', '口座を更新しました', 'account_mgmt', '更新成功メッセージ', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2311, 'account_mgmt.add_success', 'en', 'Account added successfully', 'account_mgmt', 'Add success message', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2312, 'account_mgmt.add_success', 'ja', '口座を追加しました', 'account_mgmt', '追加成功メッセージ', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2313, 'account_mgmt.delete_success', 'en', 'Account deleted successfully', 'account_mgmt', 'Delete success message', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2314, 'account_mgmt.delete_success', 'ja', '口座を削除しました', 'account_mgmt', '削除成功メッセージ', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2315, 'transaction_mgmt.failed_to_save', 'en', 'Failed to save transaction', 'transaction_mgmt', 'Save error message', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2316, 'transaction_mgmt.failed_to_save', 'ja', '入出金の保存に失敗しました', 'transaction_mgmt', '保存エラーメッセージ', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2317, 'transaction_mgmt.failed_to_load', 'en', 'Failed to load transaction', 'transaction_mgmt', 'Load error message', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2318, 'transaction_mgmt.failed_to_load', 'ja', '入出金の読み込みに失敗しました', 'transaction_mgmt', '読み込みエラーメッセージ', datetime('now'));
INSERT OR IGNORE INTO I18N_RESOURCES (RESOURCE_ID, RESOURCE_KEY, LANG_CODE, RESOURCE_VALUE, CATEGORY, DESCRIPTION, ENTRY_DT) VALUES (2319, 'category_mgmt.failed_to_hide', 'en', 'Failed to hide category', 'category_mgmt', 'Hide error message', datetime('now'));
