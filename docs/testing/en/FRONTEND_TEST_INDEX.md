...
**Total Tests**: 702 (jest suites; 22 test files, per `npm test`)
...
### Feature-Specific Tests (279 tests)
...
- **master-crud.test.js** - Shared `saveMasterEntry` + `mapMasterErrorCode` + `formatApiError` (Fable-5 #D3/#D4/#23) tests (29)
