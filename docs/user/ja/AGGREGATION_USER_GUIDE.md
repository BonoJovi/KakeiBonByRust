...
KakeiBon by Rustの集計機能では、入出金データを様々な軸で集計・分析できます。
...
KakeiBon by Rustでは、用途に応じて5つの集計方法を提供しています。
...
## ダッシュボード機能（v1.1.0 新機能）

v1.1.0から、集計データをグラフで可視化できる**ダッシュボード機能**が追加されました。

- **円グラフ**: カテゴリ別支出内訳
- **棒グラフ**: 月次収支比較
- **折れ線グラフ**: 月次トレンド（収入/支出/残高）

詳細は[ユーザーマニュアル（ダッシュボードセクション）](USER_MANUAL.md#ダッシュボード)を参照してください。
