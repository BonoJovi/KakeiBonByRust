...
[![Tests](https://img.shields.io/badge/tests-845%20passing-brightgreen.svg)](#テスト結果)
...
今後は Ver.2.2.0 で Ver.2.1.0 の繰り返しロジックを流用した「集計起算日カスタマイズ」（給料日や年金振込日に合わせて月次サイクルを設定）を予定しています。Ver.2.1.x では Weekly / Yearly UI、ルール編集機能、祝日カスタマイズ UI などの追加を予定しています。
