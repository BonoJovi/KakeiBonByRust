...
(2069, 'aggregation.error_invalid_year', 'en', 'Invalid year. Year must be between 1900 and 2100.', 'aggregation', 'Invalid year error message', datetime('now')),
(2070, 'aggregation.error_invalid_year', 'ja', '無効な年です。1900～2100の範囲で入力してください。', 'aggregation', '無効な年エラーメッセージ', datetime('now')),
(2071, 'aggregation.error_invalid_month', 'en', 'Invalid month. Month must be between 1 and 12.', 'aggregation', 'Invalid month error message', datetime('now')),
(2072, 'aggregation.error_invalid_month', 'ja', '無効な月です。1～12の範囲で入力してください。', 'aggregation', '無効な月エラーメッセージ', datetime('now')),
(2073, 'aggregation.error_invalid_date_range', 'en', 'Invalid date range. Start date must be before end date.', 'aggregation', 'Invalid date range error message', datetime('now')),
(2074, 'aggregation.error_invalid_date_range', 'ja', '無効な日付範囲です。��始日は終了日より前にしてください。', 'aggregation', '無効な日付範囲エラーメッセージ', datetime('now')),
(2075, 'aggregation.error_invalid_day', 'en', 'Invalid day for the specified month.', 'aggregation', 'Invalid day error message', datetime('now')),
(2076, 'aggregation.error_invalid_day', 'ja', '指定された月に対して無効な日です。', 'aggregation', '無効な日エラーメッセージ', datetime('now')),
(2077, 'aggregation.error_invalid_date_format', 'en', 'Invalid date format.', 'aggregation', 'Invalid date format error message', datetime('now')),
(2078, 'aggregation.error_invalid_date_format', 'ja', '無効な日付形式です。', 'aggregation', '無効な日付形式エラーメッセージ', datetime('now')),
(2081, 'aggregation.include_scheduled', 'en', 'Include Scheduled', 'aggregation', 'Include scheduled checkbox label', datetime('now')),
(2082, 'aggregation.include_scheduled', 'ja', '予定を含む', 'aggregation', '予定を含むチェックボックスラベル', datetime('now')),
