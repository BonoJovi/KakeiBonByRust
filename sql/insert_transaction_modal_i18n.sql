...
('transaction_modal.shop', 'ja', '店舗', datetime('now')),
('transaction_modal.shop', 'en', 'Shop', datetime('now')),
('transaction_modal.manage_shops', 'ja', '店舗管理', datetime('now')),
('transaction_modal.manage_shops', 'en', 'Manage Shops', datetime('now')),
