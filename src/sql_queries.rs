...
INSERT INTO TRANSACTIONS_HEADER (
    ...
    TOTAL_AMOUNT, TAX_RATE, TAX_ROUNDING, MEMO_ID, ENTRY_DT
) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, datetime('now'))
"#;

pub const TRANSACTION_HEADER_GET_BY_ID: &str = r#"
SELECT TRANSACTION_ID, USER_ID, TRANSACTION_DATE, CATEGORY1_CODE, 
       FROM_ACCOUNT_CODE, TO_ACCOUNT_CODE, TOTAL_AMOUNT, TAX_RATE, 
       TAX_ROUNDING, MEMO_ID, ENTRY_DT, UPDATE_DT
...
SET TRANSACTION_DATE = ?, CATEGORY1_CODE = ?, FROM_ACCOUNT_CODE = ?, 
    TO_ACCOUNT_CODE = ?, TOTAL_AMOUNT = ?, TAX_RATE = ?, TAX_ROUNDING = ?,
